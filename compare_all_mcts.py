#!/usr/bin/env python3
"""
Compare performance between original, optimized, and advanced MCTS implementations.
...
def benchmark_mcts(mcts_module, model_file, num_rollouts=100, num_threads=10, num_moves=3, name="MCTS"):
...
def main():
    ...
    print(f"\n{'Implementation':<20} {'Avg NPS':>10} {'Total Time':>12} {'Avg Move Time':>15} {'Min Move Time':>15} {'Max Move Time':>15}")
    print("-"*95)
    
    for name, label in [('original', 'Original'), ('optimized', 'Optimized'), ('advanced', 'Advanced')]:
        r = results[name]
        print(f"{label:<20} {r['avg_nps']:>10.1f} {r['total_time']:>12.3f}s {r['avg_time']:>15.3f}s {r['min_time']:>15.3f}s {r['max_time']:>15.3f}s")
